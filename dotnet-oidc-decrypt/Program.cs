...
internal class Program
{
    ...
    {
        var jwk = new JsonWebKey(ENC_KEY);
        var jwt = new JsonWebToken(ID_TOKEN);
        var handler = new JsonWebTokenHandler();
        var tokenValidationParams = new TokenValidationParameters
        {
            TokenDecryptionKey = jwk,
        };
        var cleartext = handler.DecryptToken(jwt, tokenValidationParams);
        Console.Write("{0}\n", cleartext);
    }
}
